...
//Metode za kontrolu akcija tipki --------------------------------------------------------------------------------------
    ...
    public void registerButtonOnAction(ActionEvent event){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/registracija.fxml"));
            ...
            ResultSet queryResult = statement.executeQuery(verfyLogin);
                ...
                if(queryResult.next()){
                    ...
                    if(uloga.equals("Korisnik")) {
                        try {
                            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/imenik.fxml"));
                            Parent root = (Parent) fxmlLoader.load();
                        ...
                        try {
                            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/korisniciAdministrator.fxml"));
                            Parent root = (Parent) fxmlLoader.load();
