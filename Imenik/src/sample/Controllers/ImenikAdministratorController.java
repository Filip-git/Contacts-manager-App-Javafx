                    ...
                    public void updateItem(String item, boolean empty) {
                        ...
                        if (empty) {
                            ...
                            editButton.setOnAction(event -> {
                                ...
                                try {
                                    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/UrediKontaktAdministrator.fxml"));
                            ...
                            deleteButton.setOnAction(event -> {
                                ...
                                brojTel = p.getBrojTel();
                                try {
                                    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/obrisiKontaktAdministrator.fxml"));
                                    Parent root = (Parent) fxmlLoader.load();
