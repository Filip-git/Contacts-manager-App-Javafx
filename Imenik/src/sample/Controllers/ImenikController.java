...
//Metode za kontroliranje akcija tipki ---------------------------------------------------------------------------------
    public void kontaktButtonOnAction(ActionEvent event){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/dodajKontakt.fxml"));
    ...
    public void podaciButtonOnAction(ActionEvent event){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/urediPodatke.fxml"));
            Parent root = (Parent) fxmlLoader.load();
    ...
    public void blokListaButtonOnAction(ActionEvent event){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/blokLista.fxml"));
            Parent root = (Parent) fxmlLoader.load();
    ...
    public void favoritiButtonOnAction(ActionEvent event){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/favoriti.fxml"));
            Parent root = (Parent) fxmlLoader.load();
    ...
    public void odjavaButtonOnAction(ActionEvent event){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/login.fxml"));
            Parent root = (Parent) fxmlLoader.load();
            Stage stageLogin = new Stage();
            stageLogin.initModality(Modality.APPLICATION_MODAL);
            stageLogin.setTitle("Imenik");
            stageLogin.setScene(new Scene(root));
            stageLogin.setResizable(false);
            stageLogin.show();
            stageLogin.onCloseRequestProperty().setValue(e -> Platform.exit());
                        ...
                        if (empty) {
                            ...
                            editButton.setOnAction(event -> {
                                ...
                                brojTel = p.getBrojTel();
                                    try {
                                        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/urediKontakt.fxml"));
                                        Parent root = (Parent) fxmlLoader.load();
                            ...
                            deleteButton.setOnAction(event -> {
                                ...
                                brojTel = p.getBrojTel();
                                try {
                                    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/obrisiKontakt.fxml"));
                                    Parent root = (Parent) fxmlLoader.load();
                            ...
                            blockButton.setOnAction(event -> {
                                ...
                                try {
                                    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/blokirajKontakt.fxml"));
                            ...
                            favoriteButton.setOnAction(event -> {
                                ...
                                if(vecDodano != 1) {
                                    try {
                                        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/favoritKontakt.fxml"));
                                        Parent root = (Parent) fxmlLoader.load();
                                    ...
                                    try {
                                        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/vecDodano.fxml"));
                                        Parent root = (Parent) fxmlLoader.load();
