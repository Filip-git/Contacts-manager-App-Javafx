...
//----------------------------------------------------------------------------------------------------------------------
    ...
    public static int ID1; //ID korisnika iz tablice
...
//Metode za kontroliranje akcija tipki ---------------------------------------------------------------------------------
    public void korisnikButtonOnAction(ActionEvent event){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/dodajKorisnik.fxml"));
    ...
    public void imenikButtonOnAction(ActionEvent event){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/imenikAdministrator.fxml"));
            Parent root = (Parent) fxmlLoader.load();
    ...
    public void blokListaButtonOnAction(ActionEvent event){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/blokListaAdministrator.fxml"));
            Parent root = (Parent) fxmlLoader.load();
    ...
    public void favoritiButtonOnAction(ActionEvent event){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/favoritiAdministrator.fxml"));
            Parent root = (Parent) fxmlLoader.load();
    ...
    public void podaciButtonOnAction(ActionEvent event){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/podaciAdministrator.fxml"));
            Parent root = (Parent) fxmlLoader.load();
    ...
    public void odjavaButtonOnAction(ActionEvent event){
        ...
        Stage stageKorisnici = (Stage) odjavaButton.getScene().getWindow();
        stageKorisnici.close();
    }
//----------------------------------------------------------------------------------------------------------------------
                    ...
                    public void updateItem(String item, boolean empty) {
                        ...
                        if (empty) {
                            ...
                            editButton.setOnAction(event -> {
                                ...
                                uloga = k.getUloga();
                                try {
                                    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/urediKorisnik.fxml"));
                                    Parent root = (Parent) fxmlLoader.load();
                            ...
                            deleteButton.setOnAction(event -> {
                                ...
                                uloga = k.getUloga();
                                try {
                                    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../FXMLFiles/obrisiKorisnik.fxml"));
                                    Parent root = (Parent) fxmlLoader.load();
